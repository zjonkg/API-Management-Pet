...
@router.post("/create", summary="Crear una nueva mascota", description="Este endpoint crea una nueva mascota en el sistema", response_model=Pet)
def create(pet: Pet):
    """
...
@router.get("/get/{pet_id}", summary="Obtener información de una mascota", description="Este endpoint obtiene la información de una mascota usando su ID", response_model=Pet)
def get(pet_id: str):
    """
...
@router.post("/assign_pet", summary="Asignar una mascota a un dueño", description="Este endpoint asigna una mascota a un dueño", response_model=Pet)
